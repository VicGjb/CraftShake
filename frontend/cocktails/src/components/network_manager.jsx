...
// Auth
	...
	GoogleLogIn(){
		...
		let host = url.host																												 
		let result = `https://accounts.google.com/o/oauth2/v2/auth?redirect_uri=https://craft-shake.com/get_code&prompt=consent&response_type=code&client_id=407812134261-0ocad46bbff1ur3kieba62jpfafuutgm.apps.googleusercontent.com&scope=openid%20email%20profile&access_type=offline`
		return result
	}
